package com.ist.neartweat.wifidirect.service;
...
import com.ist.neartweat.wifidirect.util.AsyncService;
import com.ist.neartweat.wifidirect.util.NetworkUpdateParser;
import com.ist.neartweat.wifidirect.util.Protocol;
...
public class SimWifiP2pService extends AsyncService {
	...
	public void onDestroy() {
		...
		Log.v("NearTweat","SimWifiP2pService changing to WIFI_DIABLED STATE");
        // send broadcast event: WIFI_P2P_STATE_CHANGED_ACTION
        Intent intent = new Intent();
        intent.setAction(SimWifiP2pBroadcast.WIFI_P2P_STATE_CHANGED_ACTION);
        intent.putExtra(SimWifiP2pBroadcast.EXTRA_WIFI_STATE,
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case SimWifiP2pService.NETWORK_UPDATE:
                	...
                	//Log.v("NearTweat",parser.toString());
                	if (parser.mOutSuccess) {
	                    ...
	                    if (neibChg) {
		                    ...
		                    intent.putExtra(SimWifiP2pBroadcast.EXTRA_GROUP_INFO, mGroupInfo);
	                    ...
	                    if (mshipChg) {
	                    	...
	                    	Log.v("NearTweat","MemberShipChangeAction Message"+(String)msg.obj);
		                    ...
		                    gmintent.putExtra(SimWifiP2pBroadcast.EXTRA_DEVICE_LIST, mDeviceList);
		                   
		                    sendBroadcast(gmintent);
	                    }
	                    if (oshipChg) {
		                    // send broadcast event: WIFI_P2P_GROUP_OWNERSHIP_CHANGED_ACTION
	                    	Log.v("NearTweat","GroupOwnerShipChangeAction Message"+(String)msg.obj);
		                    ...
		                    gointent.putExtra(SimWifiP2pBroadcast.EXTRA_DEVICE_LIST, mDeviceList);
		                    gointent.putExtra(SimWifiP2pBroadcast.EXTRA_DEVICE_INFO,mDevices);
